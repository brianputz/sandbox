...
(function($){	
	...
	_lang = {
		...
		_settings = {
			...
			showHTML: true, //This will show the HTML, by converting to unicode, rather than render it.
	...
	$.fn.jQuizMe = function( wordList, options, userLang ){
		...
		return this.each( function(){
			...
			stats = { 
				totalQues: 0,
				quesTried: 0,
				// rightAns[] and wrongAns[] keeps an track of the q's answer index, enabling the user to review on gameOver.s
				rightAns: [], 
				wrongAns : [],
				accur : function(){
